...
- Stat recording is deferred from Sourcemod to a Rust app called WhaleTracker-Rust, this allows for SQL writes with multithreading rather than keeping the work on TF2's single thread
