...
<div class="page">
    ...
    <div class="tabs">
        <div class="tab-controls">
            <button type="button" class="tab-button <?= $initialTab === 'tab-cumulative' ? 'active' : '' ?>" data-tab="tab-cumulative">All Time Stats</button>
            <button type="button" class="tab-button <?= $initialTab === 'tab-online' ? 'active' : '' ?>" data-tab="tab-online">
                <span class="tab-button-label">Online Now</span>
                <span class="tab-button-count" aria-live="polite">0 / 32</span>
            </button>
            <button type="button" class="tab-button <?= $initialTab === 'tab-logs' ? 'active' : '' ?>" data-tab="tab-logs">Match Logs</button>
        </div>
            ...
            <div class="table-wrapper">
                ...
                <table class="stats-table" id="stats-table-online" style="display:none">
                    ...
                    <tr>
                        ...
                        <th data-key="time" data-type="number">Time Connected</th>
                    </tr>
                    </thead>
                    <tbody></tbody>
                </table>
...
let showOldLogs = urlParams.get('show') !== 'hide';
...
function renderLogs(logs) {
    ...
    logs.forEach((log, index) => {
        ...
        const count = Number(log.player_count) || (Array.isArray(log.players) ? log.players.length : 0);
