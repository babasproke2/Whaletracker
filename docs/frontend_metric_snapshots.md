...
```cron
0 6 * * * /usr/bin/flock -n /tmp/frontend_metric_snapshot.lock /home/<USER>/Whaletracker/scripts/snapshot_frontend_metrics.sh >> /home/<USER>/.local/state/whaletracker-rust/frontend_metric_snapshot.log 2>&1
```
